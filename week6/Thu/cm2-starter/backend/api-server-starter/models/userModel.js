...
const userSchema = mongoose.Schema(
  {
    ...
    address: {
        ...
        zipCode: { type: String, required: true, match: /^\d{5}$/} // Postal/ZIP code
    }
  },
  {
    timestamps: true,
...
userSchema.statics.signup = async function (name, email, password, phone_number, gender, date_of_birth, address) {
  // validation
  if ((!name, !email || !password || !phone_number || !gender || !date_of_birth || !address.street || !address.zipCode || !address.city )) {
